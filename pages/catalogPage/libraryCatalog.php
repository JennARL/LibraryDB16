                            ...
                            <?php
                                ...
                                if(mysqli_num_rows($result) > 0)
                                {
                                    while($row = mysqli_fetch_assoc($result))
                                    {
                                        ...
                                        echo 
                                        "<td style='text-align: center'>" . "<a href='../loginPage/login.php'><input type='submit' value='Login' style='margin: 0 auto; width: 75%; background-color: lightgray; border-radius: 25px; border: 2px solid medium; padding: 5px; font-family: Geneva;'></input></a>" .
                                        "</td>";
                                        echo "</tr>";
                                    }
                                }
