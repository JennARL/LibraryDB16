<?php
    /*
        ...
        Date Modified: 2022_04_18 by Nathan Brueckner
            Description: Added the table (same style as in catalog)
        ...
        Date Modified: 2022_04_23 by Nathan Brueckner
            Modification Details: Added Check Out/Check In Functionality (for this file, the buttons and the files they link to)
	    Purpose of file:
		    Display items in library for normal users.
    */
	session_start();
		...
		<body>
			...
			<main>
                ...
                <div class="displaysearch">
                    <table id="searchtable" class="searchtable" style="color:black; text-align: center;" >
                        <thead>
                            <tr>
                                <th>Description</th>
                                <th>Actions</th>
