                    ...
                    <table class="searchtable" id="searchtable" style="color:black;">
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql = "SELECT userID, userUsername, userPassword, userFirstName, userLastName, userType, userBirthDate, userAddressLine1, userAddressLine2, userCity, userState, userZIP, libraryFines FROM user";
