<?php
    ...
    */
    ...
    $data = [
        ...
        'itemLimitVar' => $itemLimitVar,
        'bookLimitVar' => $bookLimitVar,
    ];

    $sql = "UPDATE user SET userUsername=:userUsernameVar, userPassword=:userPasswordVar, userFirstName=:userFirstNameVar, userLastName=:userLastNameVar, userType=:userTypeVar, userBirthDate=:userBirthDateVar, userAddressLine1=:userAddressLine1Var, userAddressLine2=:userAddressLine2Var, userCity=:userCityVar, userState=:userStateVar, userZIP=:userZIPVar, itemLimit=:itemLimitVar, bookLimit=:bookLimitVar WHERE userID=:userIDVar";
