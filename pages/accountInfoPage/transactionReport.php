<?php
    /*
	    ...
	    Purpose of file:
		    Display transaction report based on your specified parameters
    */
	session_start();
                        ...
                        <tbody>
                            <?php
                                ...
                                function generateReport($post)
                                {
                                    ...
                                    return "SELECT * FROM booktransaction WHERE ".implode(' AND ',$main);
                                }
                                ...
                                if(mysqli_num_rows($result) > 0)
                                {
                                    ...
                                    {
                                        echo "<tr>";
                                        echo "<td>" . "Transaction ID: " . $row['transactionID'] . "<br>" . "Book ID: " . $row['bookID'] . "<br>" . "User ID: " . $row['userID'] . "<br>" . "Transaction Date: " . $row['date'] . "<br>" . "Transaction Type: " . $row['transactionType'] . "<br>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                }
