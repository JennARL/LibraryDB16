<?php
    /*
        ...
        Purpose:
            Display books borrowed by the admin.
        Sources:
        ...
        <div id="main">
            ...
            <div id="profileinfo">
                <table>
                    ...
                    <tbody>
                        <?php
                            $sql = "SELECT bookID, bookISBN, bookTitle, userID, checkOutDate, returnDate FROM book";
                            ...
                            if(mysqli_num_rows($result) > 0)
                            {
                                while($row = mysqli_fetch_assoc($result))
                                {
                                    ...
                                    {
                                        echo "Book ISBN: " . $row['bookISBN'] . "<br>" . "Book Title: " . $row['bookTitle'] . "<br>" . "Check Out Date: " . $row['checkOutDate'] . "<br> <br>";
                                    }
                                    echo "</td>";
