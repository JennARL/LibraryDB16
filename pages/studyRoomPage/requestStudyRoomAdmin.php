<?php
    /*
	    ...
	    Purpose of file:
		    Display study rooms in library for admins.
	...
	<html style="width: 100vw;">
		...
		<body>
			...
			<main>
                ...
                <div>
                    <input type="submit" id = "addRoom" onclick="location.href='addRoom.php'" value="Add Room">
                </div>	
                            ...
                            <?php
                                ...
                                if(mysqli_num_rows($result) > 0)
                                {
                                    while($row = mysqli_fetch_assoc($result))
                                    {
                                        ...
                                        if($row['roomAvailable'] != $_SESSION['userID'])
                                        {
                                            if($row['roomAvailable'] != 0)
                                            {
                                                echo "<form action='leaveStudyRoom.php' method = 'POST'>
                                        ...
                                        <input type=submit value='Kick out of Room' style='margin: 0 auto; width: 75%; background-color:lightgrey;                                                    border-radius: 25px; border: 2px solid medium; padding: 5px; font-family: Geneva;'> </form>"; 
                                            }
                                        }
                                        echo "</td>";
                                        echo "</tr>";
