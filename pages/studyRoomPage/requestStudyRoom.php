<?php
    /*
        ...
        Date Modified: 2022_04_18 by Jenn Landicho
            Modification Details: Reformatted the tables, added styling to the tables.
        Date Modified: 2022_04_24 by Nathan Brueckner
            modification Details: Changed "Checkout" button to "Login" button

        Purpose of file:
            Allow user to view and request study rooms
    */
	session_start();
                            ...
                            <?php
                                ...
                                if(mysqli_num_rows($result) > 0)
                                {
                                    while($row = mysqli_fetch_assoc($result))
                                    {
                                        ...
                                        echo "<td style='text-align: center';>" .  "<a href='https://www.cosc3380team16.online/pages/loginPage/login.php'><input type=submit value='Login' style='margin: 0 auto; width: 75%; background-color:lightgrey;
                                        border-radius: 25px; border: 2px solid medium; padding: 5px; font-family: Geneva;'>" . "</td>";
                                        echo "</tr>";
                                    }
                                }
                            ?>
